...
package com.nims.android.fruitful.compose.ui
...
import com.nims.android.fruitful.compose.data.TagColor

/**
 * Extra theme colors for [FruitfulTheme].
 *
 * The implementation is based on
 * [Custom design systems](https://developer.android.com/jetpack/compose/themes#custom-design).
 */
@Stable
class FruitfulColors(
    star: Color,
    ...
    internal fun update(other: FruitfulColors) {
        star = other.star
        tagTexts.clear()
        tagTexts.putAll(other.tagTexts)
    }

    internal fun copy(): FruitfulColors = FruitfulColors(
        star = star,
...
internal val LocalTrackrColors = staticCompositionLocalOf<FruitfulColors> {
